...
extension TealiumHelper{
    ...
    class func incrementLifetimeValue(key: String, value: Int){
        
        guard let tealium = Tealium.instanceForKey(tealiumInstanceID) else {
            return
        }
        
        self.incrementLifetimeValue(tealium, key: key, value: value)
        
    }
    
    private class func incrementLifetimeValue(tealium: Tealium, key: String, value: Int) {
