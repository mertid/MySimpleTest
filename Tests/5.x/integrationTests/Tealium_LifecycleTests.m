...
- (void) testIsFirstLaunch{
    ...
    // If it actually is the first launch....than payload should contain key = true
    ...
    if ([defaults boolForKey:hasRunAppOnceKey] == NO)
    {
        ...
        if ([[payload allKeys] containsObject:@"lifecycle_isfirstlaunch"]) {
            XCTAssert(true);
        }
...
// This test available in unit tests
