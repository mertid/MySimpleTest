...
NSString * const TEALDataSourceKey_LifecycleIsFirstLaunchUpdate=@"lifecycle_isfirstlaunchupdate";
...
NSString * const TEALDataSourceKey_LifecyclePriorSecondsAwake=@"lifecycle_priorseondsawake";
