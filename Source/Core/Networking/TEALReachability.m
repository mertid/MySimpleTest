...
NSString *const kTEALReachabilityChangedNotification = @"kTEALReachabilityChangedNotification";

@interface TEALReachability ()
...
{
    return [TEALReachability reachabilityWithHostname:hostname];
}
...
-(instancetype)initWithReachabilityRef:(SCNetworkReachabilityRef)ref
{
    ...
    if (self != nil)
    {
        ...
        self.reachabilitySerialQueue = dispatch_queue_create("com.tealium.reachability", NULL);
    }
...
-(void)reachabilityChanged:(SCNetworkReachabilityFlags)flags
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:kTEALReachabilityChangedNotification
                                                            object:self];
    });
}
