...
NSString * const TEALDataSourceKey_LifecycleDaysSinceLastWake=@"lifecycle_dayssincelastwake";
NSString * const TEALDataSourceKey_LifecycleFirstLaunchDate=@"lifecycle_firstlaunchdate";                   //ISO 8601 | ie 2013-07-11T17:55:04Z
NSString * const TEALDataSourceKey_LifecycleFirstLaunchDate_MMDDYYYY=@"lifecycle_firstlaunchdate_MMDDYYYY"; //ie 01/18/2012
...
NSString * const TEALDataSourceKey_LifecycleTotalSecondsAwake=@"lifecycle_totalsecondsawake";
